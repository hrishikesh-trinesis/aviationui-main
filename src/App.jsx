...
import ViewWorkOrder from "./components/Workorder/ViewWorkOrder.jsx";
        ...
        <Routes>
          {!token ? (
            ...
            <>
              ...
              <Route
                path="/ViewSupplier"
                element={<ViewSupplierRegistration />}
              />
              <Route
                path="/editInspectionReportForm"
                element={<EditInspectionReportForm />}
              />
              <Route
                path="/editReport"
                element={<EditInspectionReportTable />}
              />
              <Route
              ...
              />
              <Route
                path="/editCustomerOrderForm"
                element={<EditCustomerOrderForm />}
              />
              <Route
                path="/editCustomerOrder"
                element={<EditCustomerOrderTable />}
              />
